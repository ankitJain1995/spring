...
public class User implements UserDetails {
    ...
    @JoinTable(name = "user_role",joinColumns = @JoinColumn(name = "user",referencedColumnName = "usr_id"),inverseJoinColumns = @JoinColumn(name = "role",referencedColumnName = "role_id"))
